...
def default_wsjt() -> list[SimWsjt]:
    return [
        ...
        SimWsjt("South", 50_313_000, "FT8"),
        SimWsjt("West", 50_313_000, "FT8"),
        SimWsjt("East", 50_313_000, "FT8"),
...
def main() -> None:
    ...
    if args.six_only:
        wsjt = [
            SimWsjt("South", 50_313_000),
            SimWsjt("West", 50_313_000),
            SimWsjt("East", 50_313_000),
        ]
        n1mms = [
            SimN1mm("N1MM-50", 50.0, "SSB-50-PC",
                    feeds=["South", "West", "East"], ssb_pc=True),
        ]
    else:
        wsjt = default_wsjt()
        n1mms = default_n1mm()
